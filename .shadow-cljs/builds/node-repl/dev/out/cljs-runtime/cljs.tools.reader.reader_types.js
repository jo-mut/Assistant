...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_20458 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_20458(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_20459 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_20459(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_20463 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_20463(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_20472 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_20472(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_20473 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_20473(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_20489 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_20489(reader);
}
});
...
var G__20599 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__20600 = s.append(c);
c = G__20599;
s = G__20600;
continue;
}
